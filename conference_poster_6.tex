...
\node[anchor=south east,xshift=0cm,yshift=5cm]{\includegraphics[width=10cm]{logo.png}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture,overlay,shift={(current page.south west)}]
\node[anchor=south west,xshift=5cm,yshift=5cm]{\includegraphics[width=10cm]{logo.png}};
\end{tikzpicture}
