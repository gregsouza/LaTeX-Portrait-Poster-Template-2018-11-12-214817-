...
\node[anchor=south east,xshift=0cm,yshift=3cm]{\includegraphics[height=5cm, width=20cm]{logo.png}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture,overlay,shift={(current page.south west)}]
\node[anchor=south west,xshift=5cm,yshift=3cm]{\includegraphics[height=5cm,width=20cm]{logo.png}};
\end{tikzpicture}
